...
h2. Caveats and platform specific bugs

p. There are some caveats and issues that affect the plugin's field resizing. These issues are caused by platform specific inconsistencies and behavior.
